...
public class LaserGenerator : MonoBehaviour
{
	...
	private void Start()
	{
		...
		LaserLeft.transform.localScale = new Vector3(7.5f, 0.3f, 0.0f);
		genPosition = new Vector3(240f, cameraPos.position.y+6f, 0);
		Instantiate(LaserMid, genPosition, Quaternion.identity);
		LaserMid.transform.localScale = new Vector3(7.5f, 0.3f, 0.0f);
		genPosition = new Vector3(240f, cameraPos.position.y+6f, 0);
		Instantiate(LaserRight, genPosition, Quaternion.identity);
		LaserRight.transform.localScale = new Vector3(7.5f, 0.3f, 0.0f);
